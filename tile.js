...
class Tile {
  ...
  showTile(context) {
    ...
    context.fillText(
      this.index.toString(),
      tileCenter[0] - this.size / 4, // adjustment to show the index on the tile
    ...
    if (this.snakeOrLadder == "snake") {
      ...
      context.fillText(
        ...
        tileCenter[0] - 20, // this - 20 shifts 20px to the left of the center point to show the text on the tile
        tileCenter[1]
      );
    }
